...
riverctl map normal $mod U spawn "fuzzel -i Papirus -l 20 -w 50 -f \"FantasqueSansMono Nerd Font:size=15\" -b 23262fff -t f0f0f0ff -s c792eaff -S 1a1c23ff -B 5 -r 0 -C 00A0CCff -T foot -m e0e2e2ff -x 5 -T $term"
